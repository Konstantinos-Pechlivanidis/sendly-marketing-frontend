  ...
  return (
    <div className="min-h-screen bg-bg-dark flex">
      ...
      <aside className="hidden lg:flex lg:flex-col lg:w-64 lg:fixed lg:inset-y-0 lg:z-40">
        <div className="flex-1 flex flex-col bg-surface-dark/50 backdrop-blur-[20px] border-r border-glass-border">
          {/* Logo */}
          ...
          {storeInfo && (
            <div className="px-6 py-4 border-b border-glass-border">
              <p className="text-xs text-border-subtle mb-1">Store</p>
              ...
              <Link
                ...
                className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-200 ${
                  isActive(item.path)
                    ...
                    : 'text-primary-light hover:bg-glass-white hover:text-ice-accent'
                }`}
              >
      ...
      {/* Mobile Menu Button */}
      <button
        className="lg:hidden fixed top-4 left-4 z-50 p-2 rounded-lg glass border border-glass-border text-primary-light focus-ring"
      ...
      {isMobileMenuOpen && (
        <div className="lg:hidden fixed inset-0 z-40">
          ...
          {/* Sidebar */}
          <div className="absolute left-0 top-0 bottom-0 w-64 bg-surface-dark/95 backdrop-blur-[24px] border-r border-glass-border flex flex-col">
            {/* Logo */}
